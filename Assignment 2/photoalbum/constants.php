...
define('STUDENT_NAME', 'Tong Duc Tu Tam');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '104775085');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Thursday 13:00PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'photostoragettong');
...
define('DB_ENDPOINT', 'database-1.c4xenceuexx7.us-east-1.rds.amazonaws.com');
...
define('DB_PHOTO_TABLE_NAME', 'photos_metadata');
